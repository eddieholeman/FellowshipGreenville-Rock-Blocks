            ...
            <fieldset>
                ...
                <div class="row">
                    ...
                    <asp:Panel ID="pnlInternalAuthLogin" runat="server" CssClass="col-md-6">
                        ...
                        <Rock:BootstrapButton ID="btnLogin" runat="server" Text="Log In" CssClass="btn btn-action" OnClick="btnLogin_Click" DataLoadingText="Logging In..." />
                        <asp:Button ID="btnNewAccount" runat="server" Text="Register" CssClass="btn btn-primary" OnClick="btnNewAccount_Click" CausesValidation="false" />
