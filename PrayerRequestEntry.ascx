            ...
            <div class="panel-body">
                ...
                <fieldset>
                    ...
                    <% if ( EnablePublicDisplayFlag )
                        { %>
                        <Rock:RockCheckBox ID="cbAllowPublicDisplay" runat="server" Checked="false" Label="Allow Publication?" Text="Yes" Help="If you check 'yes' you give permission to share your request via our Fellowship Prayer Connection e-newsletter. If left unchecked, your request will be distributed to Fellowship Greenville pastoral staff only." />
                    <% } %>
                </fieldset>
